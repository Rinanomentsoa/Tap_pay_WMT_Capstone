...
class AnalysisOne extends StatefulWidget {
  const AnalysisOne({Key? key}) : super(key: key);

  @override
  State<AnalysisOne> createState() => _AnalysisOneState();
}

class _AnalysisOneState extends State<AnalysisOne> {
  @override
  Widget build(BuildContext context) {
    return AnalysisWidgetOne();
  }
}

Widget AnalysisWidgetOne() {
  return ListView(
    children: [
      Column(
        children: [
